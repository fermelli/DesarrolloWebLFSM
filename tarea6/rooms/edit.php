...
<body>
  <div class="container">
    ...
    if (isset($_POST['id']) && isset($_POST['number']) && isset($_POST['space']) && isset($_POST['price']) && isset($_POST['type_room_id'])) :
      ...
      if (!empty($id) && !empty($number) && !empty($space) && !empty($price) && !empty($typeRoomId)) :

        include('./../database_init.php');

        if ($db->editRoom($id, $number, $hasPrivateBathroom, $space, $price, $typeRoomId)) :
